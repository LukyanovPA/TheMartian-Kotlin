package com.pavellukyanov.themartian.ui.main.decoration
...
class LinePagerIndicatorDecoration : RecyclerView.ItemDecoration() {
    ...
    /**
     * Высота пространства, занимаемого индикатором в нижней части обзора.
     */
    private val mIndicatorHeight = (DP * 100)

    /**
     * Ширина строки индикатора
     */
